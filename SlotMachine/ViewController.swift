...
class ViewController: UIViewController {
    ...
    func betOneButtonPressed(button: UIButton){
        if credits <= 0 {
            showAlertWithText("No More Credits", message: "Reset the Game")
        }else{
            if currentBet < 5 {
                currentBet += 1
                credits -= 1
    ...
    func setupThirdContainer(containerView: UIView){
        ...
        self.creditLabel.center = CGPoint(x: containerView.frame.width * kSixth,
        ...
        self.winnerPaidTitleLabel.center = CGPoint(x: containerView.frame.width * 5 * kSixth,
    ...
    func setupFourthContainer (containerView: UIView){
        ...
        self.betOneButton.center = CGPoint(x: containerView.frame.width * 3 * kEighth,
